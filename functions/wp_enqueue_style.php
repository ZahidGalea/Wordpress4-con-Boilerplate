...
function dl_enqueue_style() {
	...
	wp_register_style( 'ie9', get_theme_file_uri( '/assets/css/ie9.css'), null, '2.1.0', 'screen' );
	wp_register_style( 'admin', get_theme_file_uri( '/assets/css/admin.css'), null, '2.1.0', 'screen' );
	wp_register_style( 'main', get_theme_file_uri( '/assets/css/main.css'), null, '2.1.0', 'screen' );
	wp_register_style( 'nivoslider', get_theme_file_uri( '/assets/css/nivo-slider.css'), null, '2.1.0', 'screen' );
	wp_register_style( 'nivotheme', get_theme_file_uri( '/assets/css/nivotheme.css'), null, '2.1.0', 'screen' );
	wp_register_style( 'prettyphoto', get_theme_file_uri( '/assets/css/prettyPhoto.css'), null, '2.1.0', 'screen' );
	wp_register_style( 'login', get_theme_file_uri( '/assets/css/login.css'), null, '2.1.0', 'screen' );
